# aws-script-automation [![nvm version](https://img.shields.io/badge/version-v1.1.3-blue.svg)](https://pypi.org/manage/project/aws-sa/releases/) ![PyPI - Python Version](https://img.shields.io/pypi/pyversions/aws-sa.svg?color=orange)
